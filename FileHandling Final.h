...
#define MAX_ID_LENGTH 21 // Maximum length for IDs
...
void addDataAdmin(const char *filename, const char *attribute, const char *value){  // Function to add data to admin file
    ...
    if (strcmp(attribute, "adminID") == 0) {    // Compare attribute with adminID
        strncpy(newAdmin.adminID, value, MAX_ID_LENGTH - 2);    // Copy value to adminID
        newAdmin.adminID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "name") == 0) {  // Compare attribute with name
        strncpy(newAdmin.name, value, MAX_NAME_LENGTH - 2); // Copy value to name
        ...
        strncpy(newAdmin.address, value, MAX_ADDRESS_LENGTH - 2); // Copy value to address
        ...
        strncpy(newAdmin.email, value, MAX_EMAIL_LENGTH - 2); // Copy value to email
        ...
        strncpy(newAdmin.contactNumber, value, MAX_CONTACT_LENGTH - 2); // Copy value to contactNumber
        ...
        strncpy(newAdmin.password, value, MAX_PASSWORD_LENGTH - 2); // Copy value to password
    ...
    fprintf(file, "%s,%s,%s,%s,%s\n", newAdmin.adminID, newAdmin.name, newAdmin.address, newAdmin.email, newAdmin.contactNumber);   // Write new admin data to file
    fclose(file);   // Close file
    printf("Admin data added successfully.\n");
}

void addDataAdmin2(const char *filename, const char *adminID, const char *name, const char *address, const char *email, const char *contactNumber, const char *password){  // Function to add data to admin file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataCustomer(const char *filename, const char *attribute, const char *value){  // Function to add data to customer file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "customerID") == 0) {    // Compare attribute with customerID
        strncpy(newCustomer.customerID, value, MAX_ID_LENGTH - 2);    // Copy value to customerID
        newCustomer.customerID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "name") == 0) {  // Compare attribute with name
        strncpy(newCustomer.name, value, MAX_NAME_LENGTH - 2); // Copy value to name
        newCustomer.name[MAX_NAME_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "address") == 0) {  // Compare attribute with address
        strncpy(newCustomer.address, value, MAX_ADDRESS_LENGTH - 2); // Copy value to address
        newCustomer.address[MAX_ADDRESS_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "email") == 0) {  // Compare attribute with email
        strncpy(newCustomer.email, value, MAX_EMAIL_LENGTH - 2); // Copy value to email
        newCustomer.email[MAX_EMAIL_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "contactNumber") == 0) {  // Compare attribute with contactNumber
        strncpy(newCustomer.contactNumber, value, MAX_CONTACT_LENGTH - 2); // Copy value to contactNumber
...
void addDataCustomer2(const char *filename, const char *customerID, const char *name, const char *address, const char *email, const char *contactNumber){  // Function to add data to customer file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataLogistic(const char *filename, const char *attribute, const char *value){  // Function to add data to logistic file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "deliveryID") == 0) {    // Compare attribute with deliveryID
        strncpy(newLogistic.deliveryID, value, MAX_ID_LENGTH - 2);    // Copy value to deliveryID
        newLogistic.deliveryID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "name") == 0) {  // Compare attribute with name
        strncpy(newLogistic.name, value, MAX_NAME_LENGTH - 2); // Copy value to name
        newLogistic.name[MAX_NAME_LENGTH - 1] = '\0'; // Null terminate the string
    }  
    else if (strcmp(attribute, "email") == 0) {  // Compare attribute with email
        strncpy(newLogistic.email, value, MAX_EMAIL_LENGTH - 2); // Copy value to email
        newLogistic.email[MAX_EMAIL_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "contactNumber") == 0) {  // Compare attribute with contactNumber
        strncpy(newLogistic.contactNumber, value, MAX_CONTACT_LENGTH - 2); // Copy value to contactNumber
...
void addDataLogistic2(const char *filename, const char *deliveryID, const char *name, const char *email, const char *contactNumber){  // Function to add data to logistic file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataCategory(const char *filename, const char *attribute, const char *value){  // Function to add data to Category file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "categoryID") == 0) {    // Compare attribute with categoryID
        strncpy(newCategory.categoryID, value, MAX_ID_LENGTH - 2);    // Copy value to categoryID
        newCategory.categoryID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "name") == 0) {  // Compare attribute with name
        strncpy(newCategory.name, value, MAX_NAME_LENGTH - 2); // Copy value to name
        ...
        strncpy(newCategory.description, value, MAX_DESCRIPTION_LENGTH - 2); // Copy value to description
...
void addDataCategory2(const char *filename, const char *categoryID, const char *name, const char *description){  // Function to add data to Category file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataInventory(const char *filename, const char *attribute, const char *value){  // Function to add data to inventory file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "productID") == 0) {    // Compare attribute with productID
        strncpy(newInventory.productID, value, MAX_ID_LENGTH - 2);    // Copy value to productID
        newInventory.productID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "categoryID") == 0) {  // Compare attribute with categoryID
        strncpy(newInventory.categoryID, value, MAX_ID_LENGTH - 2); // Copy value to categoryID
        newInventory.categoryID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "address") == 0) {  // Compare attribute with address
        strncpy(newInventory.name, value, MAX_ADDRESS_LENGTH - 2); // Copy value to name
        newInventory.name[MAX_ADDRESS_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "price") == 0) {  // Compare attribute with price
        newInventory.price = atof(value); // Copy value to price
    } 
    else if (strcmp(attribute, "quantity") == 0) {  // Compare attribute with quantity
        newInventory.quantity = atoi(value); // Copy value to quantity
    } 
    else if (strcmp(attribute, "description") == 0) {  // Compare attribute with description
        strncpy(newInventory.description, value, MAX_DESCRIPTION_LENGTH - 2); // Copy value to description
...
void addDataInventory2(const char *filename, const char *productID, const char *categoryID, const char *name, float price, int quantity, const char *description){  // Function to add data to inventory file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataSupplier(const char *filename, const char *attribute, const char *value){  // Function to add data to supplier file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "supplierID") == 0) {    // Compare attribute with supplierID
        strncpy(newSupplier.supplierID, value, MAX_ID_LENGTH - 2);    // Copy value to supplierID
        newSupplier.supplierID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "name") == 0) {  // Compare attribute with name
        strncpy(newSupplier.name, value, MAX_ID_LENGTH - 2); // Copy value to name
        newSupplier.name[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "address") == 0) {  // Compare attribute with address
        strncpy(newSupplier.address, value, MAX_ADDRESS_LENGTH - 2); // Copy value to address
        newSupplier.address[MAX_ADDRESS_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "email") == 0) {  // Compare attribute with email
        strncpy(newSupplier.email, value, MAX_EMAIL_LENGTH - 2); // Copy value to email
        newSupplier.email[MAX_EMAIL_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "contactNumber") == 0) {  // Compare attribute with contactNumber
        strncpy(newSupplier.contactNumber, value, MAX_CONTACT_LENGTH - 2); // Copy value to contactNumber
...
void addDataSupplier2(const char *filename, const char *supplierID, const char *name, const char *address, const char *email, const char *contactNumber){  // Function to add data to supplier file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
...
void addDataTransaction(const char *filename, const char *attribute, const char *value){  // Function to add data to transaction file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "transactionID") == 0) {    // Compare attribute with transactionID
        strncpy(newTransaction.transactionID, value, MAX_ID_LENGTH - 2);    // Copy value to transactionID
        ...
        strncpy(newTransaction.adminID, value, MAX_ID_LENGTH - 2); // Copy value to adminID
        ...
        strncpy(newTransaction.productID, value, MAX_ID_LENGTH - 2); // Copy value to productID
        ...
        strncpy(newTransaction.supplierID, value, MAX_ID_LENGTH - 2); // Copy value to supplierID
        ...
        strncpy(newTransaction.date, value, MAX_DATE_LENGTH - 2); // Copy value to date
        newTransaction.date[MAX_DATE_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "quantity") == 0) {  // Compare attribute with quantity
        newTransaction.quantity = atoi(value); // Copy value to quantity
    } 
    else if (strcmp(attribute, "totalAmount") == 0) {  // Compare attribute with totalAmount
        newTransaction.totalAmount = atof(value); // Copy value to totalAmount
    }
    else {  // If attribute does not match any of the above
        printf("Invalid attribute\n");  // Print error message
        fclose(file);   // Close file
...
void addDataOrder(const char *filename, const char *attribute, const char *value){  // Function to add data to transaction file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
    ...
    if (strcmp(attribute, "orderID") == 0) {    // Compare attribute with orderID
        strncpy(newOrder.orderID, value, MAX_ID_LENGTH - 2);    // Copy value to orderID
        newOrder.orderID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    } 
    else if (strcmp(attribute, "adminID") == 0) {  // Compare attribute with adminID
        strncpy(newOrder.adminID, value, MAX_ID_LENGTH - 2); // Copy value to adminID
        ...
        strncpy(newOrder.customerID, value, MAX_ID_LENGTH - 2); // Copy value to customerID
        newOrder.customerID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "productID") == 0) {  // Compare attribute with productID
        strncpy(newOrder.productID, value, MAX_ID_LENGTH - 2); // Copy value to productID
        ...
        strncpy(newOrder.deliveryID, value, MAX_ID_LENGTH - 2); // Copy value to deliveryID
        newOrder.deliveryID[MAX_ID_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "date") == 0) {  // Compare attribute with date
        strncpy(newOrder.date, value, MAX_DATE_LENGTH - 2); // Copy value to date
        newOrder.date[MAX_DATE_LENGTH - 1] = '\0'; // Null terminate the string
    }
    else if (strcmp(attribute, "quantity") == 0) {  // Compare attribute with quantity
        newOrder.quantity = atoi(value); // Copy value to quantity
    } 
    else if (strcmp(attribute, "totalAmount") == 0) {  // Compare attribute with totalAmount
        newOrder.totalAmount = atof(value); // Copy value to totalAmount
    }
    else {  // If attribute does not match any of the above
        printf("Invalid attribute\n");  // Print error message
        fclose(file);   // Close file
    ...
    fprintf(file, "%s,%s,%s,%s,%s,%d,%.2f\n", newOrder.orderID, newOrder.adminID, newOrder.customerID, newOrder.productID, newOrder.deliveryID, newOrder.quantity, newOrder.totalAmount);   // Write new order data to file
    fclose(file);   // Close file
    printf("Order data added successfully.\n");
}

void addDataOrder2(const char *filename, const char *orderID, const char *adminID, const char *customerID, const char *productID, const char *deliveryID, const char *date, int quantity, float totalAmount){  // Function to add data to order file
    checkFileExist(filename);   // Check if file exists
    FILE *file = fopen(filename, "a");  // Open file with filename in append mode
    if (file == NULL) { // If file cannot be opened
        printf("Error opening file.\n");    // Print error message
